...
public class MD4Panel extends JPanel {
	...
	public MD4Panel() {
		setLayout(null);
		JLabel lblTitle = new JLabel("MD4");
		...
		btnHash.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!txtInput.getText().equals("") && fileChooser1 == null) {
					String hashCode = md4.convertToHashMD4(txtInput.getText());
				...
				if (txtInput.getText().equals("") && fileChooser1 != null) {
					File selectedFile = fileChooser1.getSelectedFile();
					System.out.println("Selected file: " + selectedFile.getAbsolutePath());
					String hashCode = md4.convertToHashMD4FromFile(selectedFile.getAbsolutePath());
					txtOutput.setText(hashCode);
		...
		btnCopy.setBounds(89, 161, 100, 21);
		add(btnCopy);
		...
		btnCheck.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (fileChooser2 != null && !txtHashCode.getText().equals("")) {
					File selectedFile = fileChooser1.getSelectedFile();
					boolean isNotChange = md4.checkFile(selectedFile.getAbsolutePath(), txtHashCode.getText());
					if (isNotChange) {
