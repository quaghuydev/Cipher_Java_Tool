...
//		}
	...
	public boolean isValidAESKey(String key, int limitKey) {
		try {
	...
	public AesPanel() {
		...
		comboBox.setBounds(114, 67, 52, 21);
		add(comboBox);
		JButton btnCreateKey = new JButton("Tạo key tự động");
		btnCreateKey.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				txtKey.setText("");
				String valueKey = (String) comboBox.getSelectedItem();
				key = aes.createKey(Integer.parseInt(valueKey));
		...
		btnEncrypt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!txtKey.getText().equals("")) {
					...
					String valueKey = (String) comboBox.getSelectedItem();
					if (isValidAESKey(txtKey.getText(), Integer.parseInt(valueKey))) {
						...
						if (fileExport != null && fileChooser != null) {
							try {
								...
								aes.encryptFile(fileChooser.getSelectedFile().getAbsolutePath(),
										creatPath("Aes_encrypt", fileChooser, fileExport), keyString);
						...
						if (!txtInput.getText().equals("")) {
							try {
								txtOutput.setText(aes.encryptToBase64(txtInput.getText(), keyString));
								System.out.println(aes.encryptToBase64(txtInput.getText(), keyString));
							} catch (Exception e1) {
								// TODO Auto-generated catch block
								e1.printStackTrace();
							}
				...
				if (key != null) {
					...
					if (fileExport != null && fileChooser != null) {
						try {
							...
							aes.encryptFile(fileChooser.getSelectedFile().getAbsolutePath(),
									creatPath("Aes_encrypt", fileChooser, fileExport), key);
							System.out.println("đã mã hóa");
							fileChooser = null;
							txtPathSrc.setText("");
							txtPathSrc.setVisible(false);
					...
					if (!txtInput.getText().equals("")) {
						try {
							txtOutput.setText(aes.encryptToBase64(txtInput.getText(), key));
							System.out.println(aes.encryptToBase64(txtInput.getText(), key));
						} catch (Exception e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
					...
					if (isValidAESKey(txtKey.getText(), Integer.parseInt(valueKey))) {
						...
						if (fileExport != null && fileChooser != null) {
							try {
								...
								aes.decryptFile(fileChooser.getSelectedFile().getAbsolutePath(),
										creatPath("Aes_decrypt", fileChooser, fileExport), keyString);
						...
						if (!txtInput.getText().equals("")) {
							try {
								txtOutput.setText(aes.decryptFromBase64(txtInput.getText(), keyString));
								System.out.println(aes.decryptFromBase64(txtInput.getText(), keyString));
							} catch (Exception e1) {
								// TODO Auto-generated catch block
								e1.printStackTrace();
							}
				...
				if (key != null) {
					...
					if (fileExport != null && fileChooser != null) {
						try {
							...
							aes.decryptFile(fileChooser.getSelectedFile().getAbsolutePath(),
									creatPath("Aes_decrypt", fileChooser, fileExport), key);
					...
					if (!txtInput.getText().equals("")) {
						try {
							txtOutput.setText(aes.decryptFromBase64(txtInput.getText(), key));
							System.out.println(aes.decryptFromBase64(txtInput.getText(), key));
						} catch (Exception e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
